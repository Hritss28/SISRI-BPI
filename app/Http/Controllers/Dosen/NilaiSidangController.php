...
class NilaiSidangController extends Controller
{
    ...
    public function index()
    {
        ...
        // Get penugasan as penguji for sidang_skripsi only
    ...
    public function create(PelaksanaanSidang $pelaksanaan)
    {
        ...
        if (!$penugasan) {
            return redirect()->route('dosen.nilai-sidang.index')->with('error', 'Anda tidak ditugaskan sebagai penguji untuk sidang ini.');
        }
