    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Tambah data mahasiswa baru ke sistem</p>
            </div>
            ...
            <form action="{{ route('admin.mahasiswa.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="angkatan" id="angkatan" value="{{ old('angkatan') }}" required maxlength="4" placeholder="2024"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        @error('angkatan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
