<x-app-layout>
    <div class="max-w-7xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Jadwal Sidang Skripsi</h1>
            <p class="text-sm text-gray-500 mt-1">Daftar jadwal sidang skripsi yang melibatkan Anda sebagai penguji atau pembimbing</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-xl font-bold text-gray-800">{{ $jadwalSidang->where('status', 'dijadwalkan')->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-blue-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-xl font-bold text-gray-800">{{ $jadwalSidang->where('status', 'berlangsung')->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-green-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-xl font-bold text-gray-800">{{ $jadwalSidang->where('status', 'selesai')->count() }}</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($jadwalSidang as $index => $pelaksanaan)
                                @php
                                    // Determine role
                                ...
                                <tr>
                                    <td colspan="8" class="px-6 py-4 text-center text-gray-500">
                                        <div class="flex flex-col items-center py-8">
                                            ...
                                            <p class="text-gray-500">Belum ada jadwal sidang skripsi</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
