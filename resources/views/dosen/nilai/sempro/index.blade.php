        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-2">Daftar Mahasiswa yang Perlu Dinilai (Seminar Proposal)</h3>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Sempro</th>
                                    ...
                                    @foreach($penugasan as $index => $tugas)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('dosen.nilai-sempro.create', $tugas->pelaksanaanSidang->id) }}" 
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Belum ada mahasiswa seminar proposal yang ditugaskan untuk Anda nilai.</p>
                        </div>
                    @endif
                </div>
            </div>
